// app/swapdeal-uppsala/HeroClient.js
'use client';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 relative z-10">
        ...
        <header className="mb-8 sm:mb-12">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold bg-gradient-to-r from-gray-900 via-green-600 to-gray-900 bg-clip-text text-transparent drop-shadow-lg leading-tight">
             Hållbarhet Uppsala - Cirkulär Ekonomi med SwapDeals          </h1>
        </header>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start group">
                    ...
                    <div className="flex-1 pt-1">
                      ...
                      <p className="text-sm sm:text-base text-gray-600">Förläng produkters livscykler genom smart återanvändning i Uppsala</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start group">
                    ...
                    <div className="flex-1 pt-1">
                      ...
                      <p className="text-sm sm:text-base text-gray-600">Anslut med likasinnade i Uppsala</p>
                    </div>
                  </div>
                </div>

...
// Parse slug with timestamp
const parseSlug = (slug) => {
  if (!slug) return { baseSlug: null, timestamp: null };
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 p-4">
        ...
        <Link
          ...
          className="bg-gradient-to-r from-yellow-400 to-yellow-600 hover:from-yellow-500 hover:to-yellow-600 text-white px-6 py-3 rounded-lg font-medium flex items-center"
        >
      ...
      <header className="bg-white shadow-sm border-b sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <Link href="/tradelistingpage">
            <button className="bg-gradient-to-r from-green-400 to-green-500 hover:from-green-500 hover:to-green-600 text-white px-6 py-2 rounded-full font-medium flex items-center">

...
const FEATURES = [
  {
    icon: Leaf,
    title: "Hållbar Byteshandel i Göteborg",
    description: "Byt lokalt, gratis och hållbart. Ge begagnade prylar nytt liv utan mellanhänder ett smart och miljövänligt alternativ till nyköp och second hand-shopping.",
    gradient: "from-green-50/90 to-green-100/60",
    hoverGradient: "hover:from-green-100 hover:to-green-200/70",
  ...
  {
    icon: "💰",
    title: "100% Gratis Bytesmarknad",
    description: "Byt kläder, möbler, elektronik och mycket mer helt utan pengar. En gratis bytesplattform där värde byts mot värde, utan avgifter eller provision.",
    gradient: "from-blue-50/90 to-blue-100/60",
    hoverGradient: "hover:from-blue-100 hover:to-blue-200/70",
  ...
  {
    icon: Shield,
    title: "Säker Byteshandel i Göteborg",
    description: "Trygg byteshandel i Göteborg. Byt kläder, möbler, elektronik och mer helt lokalt och utan avgifter. Ge prylar nytt liv och handla med förtroende.",
    gradient: "from-purple-50/90 to-purple-100/60",
    hoverGradient: "hover:from-purple-100 hover:to-purple-200/70",
...
const SUSTAINABLE_BENEFITS = [
  ...
  },
  {
    ...
    description: "Anslut med likasinnade i Göteborg",
      ...
      <div className="space-y-6 order-1 lg:order-1">
        ...
        <nav className="flex flex-col gap-3 pt-6 sm:flex-row sm:gap-4" aria-label="Primära åtgärder">
          <Link
            ...
            aria-label="Börja byta begagnade prylar i Göteborg"
          >
            <ArrowLeftRight className="w-5 h-5 mr-2 flex-shrink-0" strokeWidth={2.5} aria-hidden="true" />
            <span className="whitespace-nowrap">Börja Byta Eller Ge Bort</span>
          </Link>
      ...
      <div className="order-2 lg:order-2 transform hover:scale-105 transition-transform duration-500">
        <div className="relative w-full">
          ...
          <figure className="relative bg-gradient-to-br from-white via-green-50/30 to-white backdrop-blur-sm rounded-3xl shadow-2xl border-2 border-green-300/50 overflow-hidden">
            <Image
              src="/bytaprylar.webp"
              alt="Byteshandel i Göteborg byt begagnade kläder, möbler, elektronik på SwapDeals bytesplattform"
              width={800}
              height={800}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <article 
                key={index}
                className={`text-center p-6 sm:p-8 rounded-2xl bg-gradient-to-br ${feature.gradient} ${feature.hoverGradient} transition-all duration-300 transform hover:scale-105 hover:shadow-xl border ${feature.borderColor} ${index === 2 ? 'sm:col-span-2 lg:col-span-1' : ''}`}
              >
                <div 
                  className={`w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-br ${feature.iconBg} rounded-3xl flex items-center justify-center mx-auto mb-5 shadow-xl`}
                  aria-hidden="true"
                >
                  {IconComponent ? (
                    <IconComponent className={`w-8 h-8 sm:w-10 sm:h-10 ${feature.iconColor}`} strokeWidth={2.5} />
                  ) : (
